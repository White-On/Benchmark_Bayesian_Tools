...
learner = gum.BNLearner(f"{currentdir}/data/sample_{sys.argv[1]}_micro_child.csv")
learner.useMIIC()
learner.useScoreBIC()
...
# Save the model
gum.saveBN(bnlearned, f"{currentdir}/data/pyAgrum_learned_{sys.argv[1]}_micro_child.bif")
